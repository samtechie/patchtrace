defmodule PatchtraceWeb.CategoryControllerTest do
  use PatchtraceWeb.ConnCase

  alias Patchtrace.Projects

  @create_attrs %{nname: "some nname"}
  @update_attrs %{nname: "some updated nname"}
  @invalid_attrs %{nname: nil}

  def fixture(:category) do
    {:ok, category} = Projects.create_category(@create_attrs)
    category
  end
  ...
  describe "update category" do
    ...
    test "redirects when data is valid", %{conn: conn, category: category} do
      ...
      assert html_response(conn, 200) =~ "some updated nname"
    end
